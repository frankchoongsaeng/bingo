...
/**
 * A player's 5x5 bingo card. Called numbers auto-daub; the winning line, if
 * any, is highlighted. Purely presentational.
 */
export function BingoCard({ card, calledSet, winningLine, dimmed }: BingoCardProps) {
